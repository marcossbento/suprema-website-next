        ...
        <main className="min-h-screen bg-primary-dark text-white font-sans selection:bg-greenSup selection:text-white">
            ...
            <section className="py-20 bg-white/5">
                <div className="container px-6 md:px-12 mx-auto">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-bold mb-4">Soluções para Todos os Setores</h2>
                        <div className="w-20 h-1.5 bg-greenSup rounded-full mx-auto" />
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                className="group bg-primary-dark border border-white/10 p-8 rounded-3xl hover:border-greenSup/50 transition-all duration-300 hover:-translate-y-2"
                            >
            ...
            <section className="py-20 px-6 md:px-12 relative overflow-hidden">
                ...
                <div className="container mx-auto relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="bg-primary-dark rounded-[22px] p-8 md:p-12 text-center">
                                <div className="w-20 h-20 bg-greenSup/20 rounded-full flex items-center justify-center text-greenSup mx-auto mb-6">
                                    <FileCheck size={40} />
                                </div>
                                ...
                                <Link
                                    href="/#contato"
                                    className="inline-flex items-center gap-2 px-8 py-4 bg-greenSup text-white rounded-full font-bold hover:bg-greenSup-dark transition-all transform hover:scale-105 shadow-lg shadow-greenSup/20"
                                >
                                    Solicitar Orçamento
                                    <ArrowRight size={20} />
                                </Link>
