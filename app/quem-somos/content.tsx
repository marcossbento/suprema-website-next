                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10 h-full">
                    <div className="flex flex-col md:flex-row items-center h-full gap-12 pt-32 pb-20">
                        ...
                        >
                            ...
                            {/* Floating Badge */}
                            <div className="absolute bottom-8 right-8 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-lg max-w-[200px]">
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    <div className="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-gray-100">
                        <div className="flex flex-col md:flex-row">
                            ...
                            <motion.div
                                ref={historyRef}
                                className="w-full md:w-2/5 relative min-h-[400px] md:min-h-full group"
                            >
                                <Image
                                ...
                                />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent md:bg-gradient-to-r md:from-black/50 md:to-transparent" />

                                {/* Glassmorphism Card for "Desde 2001" */}
                                <div className="absolute bottom-8 left-8 right-8 md:right-auto">
                                    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-xl relative overflow-hidden">
                                        <div className="absolute top-0 left-0 w-1 h-full bg-greenSup" />
                                        <p className="font-bold text-3xl text-white mb-2">Desde 2001</p>
                                        <p className="text-sm text-gray-200 leading-relaxed">
                                            Construindo um legado de confiança e precisão em cada análise.
                                        </p>
                                    </div>
                                </div>
                            </motion.div>
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp} className="group bg-white p-8 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 relative overflow-hidden">
                            ...
                            <h3 className="text-2xl font-bold text-primary-dark mb-4 group-hover:text-blue-700 transition-colors">Satisfação do Cliente</h3>
                            <p className="text-gray-600 leading-relaxed">
                                Atendimento ágil, humanizado e cumprimento rigoroso de prazos e normas, colocando você em primeiro lugar.
                            </p>
                        </motion.div>
                        ...
                        <motion.div variants={fadeInUp} className="group bg-white p-8 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 relative overflow-hidden">
                            ...
                            <h3 className="text-2xl font-bold text-primary-dark mb-4 group-hover:text-greenSup-dark transition-colors">Compromisso Real</h3>
                            <p className="text-gray-600 leading-relaxed">
                                Segurança jurídica e tranquilidade para quem nos contrata, garantindo resultados que você pode confiar.
                            </p>
                        </motion.div>
                        ...
                        <motion.div variants={fadeInUp} className="group bg-white p-8 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 relative overflow-hidden">
                            ...
                            <h3 className="text-2xl font-bold text-primary-dark mb-4 group-hover:text-purple-700 transition-colors">Inovação Constante</h3>
                            <p className="text-gray-600 leading-relaxed">
                                Novos métodos e eficiência analítica para superar expectativas, mantendo-nos sempre à frente.
                            </p>
                        </motion.div>
                    </motion.div>
                </div>
